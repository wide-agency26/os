      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`px-3 py-2 border rounded text-[13px] font-medium transition-colors flex items-center gap-2 ${
              showFilters
            ...
            <table className="w-full text-left text-[13px]">
              ...
              <tbody>
                {filteredCustomers.length === 0 && !loading ? (
                  <tr><td colSpan={9} className="text-center py-10 text-gray-500">No records match your filters.</td></tr>
                ) : (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className={`px-2 py-1 rounded text-xs font-medium ${
                          c.record_kind === 'company' ? 'bg-indigo-100 text-indigo-700' : 'bg-slate-100 text-slate-700'
                        }`}>
                          {c.record_kind === 'company' ? 'Company' : 'Contact'}
                        </span>
                      </td>
                      <td className="px-4 py-3 text-gray-600">
                        {c.record_kind === 'contact' && c.parent?.company
                          ? c.parent.company
                          : c.company || '-'}
                      </td>
                      <td className="px-4 py-3">
