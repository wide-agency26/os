    ...
    <>
      <div className="mb-8 flex justify-between items-start">
        ...
        <div className="flex gap-2">
          <Link href={`/app/projects/task?project=${projectId}`} className="px-4 py-2 bg-white border border-gray-300 rounded text-[13px] font-medium text-gray-700 hover:bg-gray-50 transition-colors">
            View Tasks
          </Link>
          <Link href={`/app/projects/timesheet?project=${projectId}`} className="px-4 py-2 bg-blue-600 text-white rounded text-[13px] font-medium hover:bg-blue-700 transition-colors">
            Log Time
          </Link>
        </div>
      </div>
