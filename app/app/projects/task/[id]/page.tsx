    ...
    async function fetchData() {
      ...
      if (taskData) {
        setFormData({
          ...
          weight: taskData.weight?.toString() || "0",
          progress: taskData.progress?.toString() || "0",
          expected_start_date: taskData.expected_start_date || "",
          expected_end_date: taskData.expected_end_date || "",
          expected_time: taskData.expected_time?.toString() || "",
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-200">
          <div className="flex items-center gap-4">
            <Link href="/app/projects/task" className="text-gray-400 hover:text-gray-900 transition-colors">
              <ArrowLeft size={20} />
            </Link>
            <div>
